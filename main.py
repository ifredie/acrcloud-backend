            ...
            for item in deteccion.get("metadata", {}).get("custom_files", []):
                if item.get("acrid") == material.acr_id:
                    ...
                    resultados.append({
                        ...
                        "grabacion": f"https://api-v2.acrcloud.com/api/bm-cs-projects/{proyecto_id}/streams/{stream_id}/recordings?timestamp_utc={dt_utc.strftime('%Y%m%d%H%M%S')}&played_duration=60"
                    })
    return resultados
